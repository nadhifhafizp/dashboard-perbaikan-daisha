    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-2.5">
          ...
          <p className="text-xs font-medium text-slate-500">Memuat Manajemen Pengguna...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 max-w-lg mx-auto text-center space-y-4 my-12">
        ...
        <p className="text-xs text-slate-600 leading-relaxed">
          Halaman Manajemen Pengguna hanya dapat diakses oleh Administrator Workshop.
        </p>
        <Link
          href="/"
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-200">
        <div className="space-y-1">
          <nav className="flex items-center gap-1.5 text-xs text-slate-500">
            ...
            <span className="font-semibold text-slate-900">Manajemen Pengguna</span>
          </nav>
          <div>
            ...
            <p className="text-[11px] sm:text-xs text-slate-500 font-normal mt-0.5">
              Kelola kredensial akun operator workshop, user seksi, dan administrator
            </p>
          </div>
        </div>
